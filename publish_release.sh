...
DLL=Greydwarfs Dont Circle/bin/Release/GreydwarfsDontCircle.dll
PLUGINS=Greydwarfs Dont Circle/Package/plugins
README=README.md
...
ZIPDESTINATION="../bin/Release/GreydwarfsDontCircle.$VERSION.zip"
